    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsFurni">
            ...
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                ...
                <!-- DASHBOARD ADMIN -->
                <li class="nav-item">
                    <a class="nav-link px-3 {{ Request::is('admin/dashboard*') ? 'active fw-bold' : '' }}"
                ...
                <!-- BARANG -->
                <li class="nav-item">
                    <a class="nav-link px-3 {{ Request::is('barang*') ? 'active fw-bold' : '' }}"
                ...
                <!-- LAPORAN -->
                <li class="nav-item">
                    <a class="nav-link px-3 {{ Request::is('laporan*') ? 'active fw-bold' : '' }}"
                ...
                <!-- DATA PENGGUNA -->
                <li class="nav-item">
                    <a class="nav-link px-3 {{ Request::is('datpen*') ? 'active fw-bold' : '' }}"
                       href="{{ route('datpen.index') }}">
                        Data Pengguna
                    </a>
                </li>
